...
{
  public static final String VERSION_NAME = "0.7.2 (Dev)";
  ...
  public static final int MINIMUM_BOOTSTRAP_SUPPORTED = 2;
  public static final String URL_BOOTSTRAP_DOWNLOAD = "http://mojang.com/2013/04/1-5-2-pre-release-and-13w17a-snapshot-oh-my/";
  public static final String[] LAUNCHER_OUT_OF_DATE_BUTTONS = { "Go to URL", "Close" };
}