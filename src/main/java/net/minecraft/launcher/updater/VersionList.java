...
public abstract class VersionList
{
  ...
  public CompleteVersion getCompleteVersion(Version version) throws IOException {
    ...
    CompleteVersion complete = (CompleteVersion)gson.fromJson(getUrl("versions/" + version.getId() + "/" + version.getId() + ".json"), CompleteVersion.class);
  ...
  public void refreshVersions() throws IOException {
    ...
    RawVersionList versionList = (RawVersionList)gson.fromJson(getUrl("versions/versions.json"), RawVersionList.class);
